# modified this file to point to different data directory
...
def get_transformed_data():
    ...
    if not os.path.exists('kaggle-digit-recognition/train.csv'):
        print('Looking for kaggle-digit-recognition/train.csv')
        print('You have not downloaded the data and/or not placed the files in the correct location.')
        print('Please get the data from: https://www.kaggle.com/c/digit-recognizer')
        print('Place train.csv in the folder kaggle-digit-recognition adjacent to the class folder')
        exit()

    df = pd.read_csv('kaggle-digit-recognition/train.csv')
